...
`plots`, which has one row per plot that describes the tells you if the plot is a `control` plot or an `exclosure` plot where the dominant kangaroo rat species have been excluded.
